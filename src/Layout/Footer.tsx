...
const Footer = (props: Props) => {
    return (
        <div className='py-10  px-5 text-center z-50 w-full text-white bg-slate-900'>
            ...
            <div id="footer" className='font-medium z-50 md:grid place-items-center w-full'>

                <section className='flex md:w-[3/5] item-center z-50 w-full  py-3 my-3 justify-between'>
                    <div className='leading-8 font-semibold items-start flex flex-col'>
                        <p onClick={() => window.location.replace('https://hashnode.com/@codingpastor')} className='z-50 flex items-center'><span className="text-blue-700"><SiHashnode /></span><a className="ml-3" href='https://hashnode.com/@codingpastor'>Hashnode</a></p>
                ...
                <hr></hr>
                <p className="py-3 font-semibold z-50 ">2023. Built with Love By <a href='https://github.com/AduwoAyooluwa'>Coding Pastor</a></p>
            </div>
        </div>
    )
}
