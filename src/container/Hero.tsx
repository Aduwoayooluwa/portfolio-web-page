...
const Hero = (props: Props) => {
    ...
    return (
        <>
            ...
            {/* { audio } */}
            <main className='saturate-100 h-screen w-full flex flex-col items-center justify-center'>
                ...
                <section className='px-0 md:px-4 flex justify-center md:justify-between items-center md:flex-row flex-col mt-14 md:mt-0  text-white z-20 h-fit w-4/5 md:h-[400px]' >
                    ...
                    <div className='w-full h-fit'>
                        ...
                        <div className='border rounded-md p-2 mr-2 my-3'>
                            <code color='' className='list-none w-full text-white md:w-1/2 my-3 text-transparent'>A Human Spider with 3+ years of experience in creating web for businesses and enterprises</code>
                        </div>
